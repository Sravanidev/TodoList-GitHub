...
//fectching movies from API.

async function loadMovies(searchTerm){
    const URL = `https://www.omdbapi.com/?s=${searchTerm}&page=1&apikey=5f9b0344`;
...
function loadMovieDetails(){
    ...
    searchListMovies.forEach(movie =>{
        movie.addEventListener('click', async() => {
            ...
            const result = await fetch(`http://www.omdbapi.com/?i=${movie.dataset.id}&apikey=5f9b0344`);
...
<div class="movie-info">
    ...
    <p clas="actors"><b>Actors:</b>${details.Actors}</p>
